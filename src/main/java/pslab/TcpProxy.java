...
public class TcpProxy {
    ...
    public TcpProxy(InetAddress local, int local_port, InetAddress remote, int remote_port, boolean verbose, boolean debug) {
        ...
        TcpProxy.debug = debug;
    }

    public TcpProxy(InetAddress local, int local_port, InetAddress remote, int remote_port,
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            p = new TcpProxy(local, local_port, remote, remote_port, verbose, debug, mapping_file);
            p.start();
        } catch (Throwable ex) {
            ex.printStackTrace();
        }
