...
@Setter
@EqualsAndHashCode
public class MyPageResData<T> implements java.io.Serializable {
    ...
    public MyPageResData() {

    }

    public MyPageResData(Page<T> jpage, Long current, Long size) {
    ...
    public MyPageResData(Long current, Long size, Long total, List<T> list) {
        this.current = current;
        this.size = size;
        this.total = total;
        calcProperites();
